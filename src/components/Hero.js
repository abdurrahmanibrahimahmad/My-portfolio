          ...
          <div className="  py-28" data-aos="zoom-in">
            ...
            <div className="grid justify-center items-center mt-3">
              ...
              <div className="text-center">
                ...
                <div className="m-auto mt-4 max-w-3xl flex items-center justify-center gap-x-6">
                  <p>
                    Frontend Developer based in Kaduna State, Nigeria, skilled
                    in HTML, CSS, JavaScript, React, and Tailwind CSS.
                ...
                <div className="mt-10 flex items-center justify-center gap-x-4">
                  <a
                    href="https://www.linkedin.com/in/abdurrahman-ibrahim-36b413328/"
                  ...
                  <a
                    href="https://github.com/abdurrahmanibrahimahmad"
                    className="btn btn-outline btn-square"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
